  ...
  return (
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-purple-900 via-violet-900 to-indigo-900 lg:flex lg:w-1/2">
      ...
      <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
        <Link href="/" className="mb-12 flex cursor-pointer items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-violet-400/30 bg-violet-500/20 backdrop-blur-sm">
            <AudioWaveform className="h-7 w-7 text-violet-300" />
          </div>
        ...
        <div className="max-w-md">
          ...
          <p className="mb-8 text-lg leading-relaxed text-violet-100/90">
            Join thousands of creators using advanced AI to generate realistic,
            natural-sounding voices in seconds.
          </p>
        ...
        <div className="mt-16 grid grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <div className="text-sm text-violet-300/70">Voices Generated</div>
          </div>
          <div className="text-center">
...
async function AuthLayoutInner({ children }: { children: ReactNode }) {
  return (
