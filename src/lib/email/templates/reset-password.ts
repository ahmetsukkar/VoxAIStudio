          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.7;">
                We received a request to reset your <strong>Vox AI Studio</strong> password.
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;">
                      ⚠️ &nbsp;<strong>Security notice:</strong> This link expires in
                      <strong>1 hour</strong>. Never share this link with anyone.
                      Vox AI Studio will never ask for your password.
                    </p>
                  </td>
                </tr>
              </table>
